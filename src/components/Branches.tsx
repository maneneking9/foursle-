  ...
  const branches = [
    {
      ...
      image: branchImages.find(img => img.branch_name === 'Foursquare City Light')?.image_url || "/images/branch/Screenshot 2026-03-07 153508.png",
      pastor: "Rev. Roger Brubeck",
      services: ["Sunday: 8:00 AM, 10:00 AM, 5:00 PM", "Wednesday: 7:00 PM", "Friday: 6:30 PM"],
      description: "Our main campus in the heart of Kigali, serving as a beacon of hope and faith for the community.",
      ...
      history: "Founded in 2005, City Light began as a small prayer group and has grown into a thriving community of believers.",
      worshippers: "2,500+",
    ...
    },
    {
      ...
      image: branchImages.find(img => img.branch_name === 'Word Light Branch')?.image_url || "/images/branch/Screenshot 2026-03-07 154024.png",
      pastor: "Pastor Sarah Uwase",
      services: ["Sunday: 9:30 AM", "Thursday: 6:30 PM"],
      description: "A center for biblical excellence and spiritual growth, focusing on the transformative power of God's Word.",
      mission: "To build a foundation of faith through deep study of God's Word and empower believers to live out their calling.",
      history: "Established in 2010, Word Light was born from a vision to create a center for theological education and spiritual formation.",
      worshippers: "1,200+",
